...
export declare class ConnectionTreeItem extends vscode.TreeItem {
    readonly nodeType?: "ws" | "mcp" | "model" | "mcp-tool" | "detail" | undefined;
    constructor(label: string, collapsibleState?: vscode.TreeItemCollapsibleState, nodeType?: "ws" | "mcp" | "model" | "mcp-tool" | "detail" | undefined);
}
