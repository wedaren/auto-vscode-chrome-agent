...
- [~] 不考虑时间，使用最优解，希望能做一些深度调研的工作，类似 google 的 gemini 的深度调研（已拆解为 evo_v35_001, evo_v35_002, evo_v35_003, evo_v35_004, evo_v35_005 — 深度调研体系：DeepResearchEngine 迭代式研究循环 + WebSocket 调研协议 + Chrome ResearchPanel UI + 结构化引用报告导出 + /research 斜杠命令）
