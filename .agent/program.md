...
- [~] 不考虑时间，使用最优解，提供沉浸式翻译的 skill，要参考 chrome 插件 沉浸式翻译，提供最好的用户体验（已拆解为 evo_v19_001, evo_v19_002, evo_v19_003, evo_v19_004, evo_v19_005 — 沉浸式翻译体系：browser_extract_paragraphs 智能段落提取 + browser_inject_bilingual 双语注入 + llm_translate LLM 工具路由 + immersive_translate 4 步预设 Skill + Chrome Toggle/Clear UI 控制）