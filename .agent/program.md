...
- [~] 不考虑时间，使用最优解，沉浸式翻译能提供原文版与翻译版，或者混合版（已拆解为 evo_v34_001, evo_v34_002, evo_v34_003, evo_v34_004, evo_v34_005 — 三种显示模式：ImmersiveOverlay DisplayMode 引擎 + action-executor setDisplayMode + TranslateControl 三模式分段控制器 + VSCode Schema 扩展）
