...
- [~] 考虑只有唯一客户端，减少没必要的重连（已拆解为 evo_v16_001, evo_v16_002, evo_v16_003, evo_v16_004, evo_v16_005 — 单客户端优化：Server activeClient 单引用 + 踢旧连接 + Client 连接去重 + 可见性感知重连 + welcome 握手）